...
(* OASIS_START *)
(* DO NOT EDIT (digest: 955bc6f438860baa5ba703ea1f4cedf6) *)
(*
...
let setup_t =
  {
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/mrnumber/gapi-ocaml.git";
                      src_repo_browser =
                        Some "https://github.com/mrnumber/gapi-ocaml";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "Úz¯¸n#Ð²\144kÑLfàÉ\r";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
